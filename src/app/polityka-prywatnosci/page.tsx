...
export const metadata: Metadata = {
  title: 'Polityka Prywatności | QonnectOne',
  description: 'Polityka Prywatności serwisów internetowych QonnectOne Sp. z o.o. - informacje o przetwarzaniu danych osobowych zgodnie z RODO.',
};
