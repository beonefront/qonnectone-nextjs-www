...
export const metadata: Metadata = {
  title: 'Polityka Cookies | QonnectOne',
  description: 'Polityka prywatności i plików cookies na stronie internetowej spółki QonnectOne sp. z o.o. - informacje o wykorzystywaniu cookies.',
};
