...
import ModulyPageClient from '@/components/ModulyPageClient';
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        'pl-PL': 'https://qonnectone.com/moduly',
        en: 'https://qonnectone.com/en/moduly',
        'en-US': 'https://qonnectone.com/en/moduly',
        uk: 'https://qonnectone.com/ua/moduly',
        'uk-UA': 'https://qonnectone.com/ua/moduly',
      },
    },
  };
}
