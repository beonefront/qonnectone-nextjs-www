...
export default function ModulyPageClient() {
    ...
    <>
      ...
      <section id="hero">
        <div className="relative flex w-full flex-col items-center justify-start px-4 pt-32 sm:px-6 sm:pt-24 md:pt-32 md:pb-16 lg:px-8">
          ...
          <p className="mt-5 text-sm text-foreground/70">{t('hero.tagline')}</p>
        </div>
      </section>
      ...
      <section id="modules" className="bg-neutral-100">
        <div className="relative container bg mx-auto px-4 pb-22 max-w-7xl">
          <div className="text-center space-y-4 pb-6 pt-28 mx-auto">
            <h2 className="text-sm text-primary font-mono font-medium tracking-wider uppercase">{t('modulesSection.eyebrow')}</h2>
          ...
          <div className="mx-auto mt-16 grid max-w-7xl grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-gray-500">
            ...
            <div className="group relative overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-blue-500/10 transition-all duration-500 ease-out md:col-span-2">
              <div className="mb-4">
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.transaction.title')}</h3>
                <p className="text-foreground text-sm mb-4">
                  {t('modulesSection.transaction.description')}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                ...
                <div className="bg-white p-2 rounded-lg border border-gray-200 hover:border-blue-300 transition-all">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-semibold text-xs text-gray-900">{t('modulesSection.transaction.methods.cards.title')}</h4>
                  </div>
                  <p className="text-[10px] text-gray-600">{t('modulesSection.transaction.methods.cards.subtitle')}</p>
                </div>
                ...
                <div className="bg-white p-2 rounded-lg border border-gray-200 hover:border-green-300 transition-all">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-semibold text-xs text-gray-900">{t('modulesSection.transaction.methods.blik.title')}</h4>
                  </div>
                  <p className="text-[10px] text-gray-600">{t('modulesSection.transaction.methods.blik.subtitle')}</p>
                </div>
                ...
                <div className="bg-white p-2 rounded-lg border border-gray-200 hover:border-yellow-300 transition-all">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-semibold text-xs text-gray-900">{t('modulesSection.transaction.methods.transfers.title')}</h4>
                  </div>
                  <p className="text-[10px] text-gray-600">{t('modulesSection.transaction.methods.transfers.subtitle')}</p>
                </div>
                ...
                <div className="bg-white p-2 rounded-lg border border-gray-200 hover:border-purple-300 transition-all">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-semibold text-xs text-gray-900">{t('modulesSection.transaction.methods.wallets.title')}</h4>
                  </div>
                  <p className="text-[10px] text-gray-600">{t('modulesSection.transaction.methods.wallets.subtitle')}</p>
                </div>
                ...
                <div className="bg-white p-2 rounded-lg border border-gray-200 hover:border-indigo-300 transition-all">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-semibold text-xs text-gray-900">{t('modulesSection.transaction.methods.installments.title')}</h4>
                  </div>
                  <p className="text-[10px] text-gray-600">{t('modulesSection.transaction.methods.installments.subtitle')}</p>
                </div>
                ...
                <div className="bg-white p-2 rounded-lg border border-gray-200 hover:border-orange-300 transition-all">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h4 className="font-semibold text-xs text-gray-900">{t('modulesSection.transaction.methods.crypto.title')}</h4>
                  </div>
                  <p className="text-[10px] text-gray-600">{t('modulesSection.transaction.methods.crypto.subtitle')}</p>
                </div>
              </div>
              ...
              <div className="mt-3 pt-3 border-t border-gray-200">
                <p className="text-[10px] text-gray-600 flex items-center gap-1">
                  ...
                  {t('modulesSection.transaction.compliance')}
                </p>
              </div>
            </div>
            ...
            <div className="group relative items-start overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-red-500/10 transition-all duration-500 ease-out">
              <div>
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.items.aml.title')}</h3>
                <p className="text-foreground">
                  {t('modulesSection.items.aml.description')}
                </p>
              </div>
              <svg
                width="1203"
            ...
            <div className="group relative items-start overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-orange-500/10 transition-all duration-500 ease-out">
              <div>
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.items.crypto.title')}</h3>
                <p className="text-foreground">
                  {t('modulesSection.items.crypto.description')}
                </p>
              </div>
              <svg
                width="1203"
            ...
            <div className="group relative items-start overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-green-500/10 transition-all duration-500 ease-out">
              <div>
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.items.reporting.title')}</h3>
                <p className="text-foreground">
                  {t('modulesSection.items.reporting.description')}
                </p>
              </div>
              <svg
                width="1203"
            ...
            <div className="group relative items-start overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-purple-500/10 transition-all duration-500 ease-out md:col-span-2">
              <div>
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.items.accounting.title')}</h3>
                <p className="text-foreground">
                  {t('modulesSection.items.accounting.description')}
                </p>
              </div>
              <svg
                width="1203"
            ...
            <div className="group relative items-start overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-indigo-500/10 transition-all duration-500 ease-out">
              <div>
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.items.administration.title')}</h3>
                <p className="text-foreground">
                  {t('modulesSection.items.administration.description')}
                </p>
              </div>
              <svg
                width="1203"
            ...
            <div className="group relative items-start overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-teal-500/10 transition-all duration-500 ease-out">
              <div>
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.items.backoffice.title')}</h3>
                <p className="text-foreground">
                  {t('modulesSection.items.backoffice.description')}
                </p>
              </div>
              <svg
                width="1203"
            ...
            <div className="group relative items-start overflow-hidden bg-neutral-50 p-6 rounded-2xl hover:bg-emerald-500/10 transition-all duration-500 ease-out md:col-span-2">
              <div>
                <h3 className="font-semibold mb-2 text-primary">{t('modulesSection.items.api.title')}</h3>
                <p className="text-foreground">
                  {t('modulesSection.items.api.description')}
                </p>
              </div>
              <svg
                width="1203"
              ...
              <div className="group relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="relative">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-1">{t('cta.saas.title')}</h3>
                      <p className="text-primary font-medium">{t('cta.saas.subtitle')}</p>
                    </div>
                  </div>
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>{t('cta.saas.feature1')}</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>{t('cta.saas.feature2')}</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>{t('cta.saas.feature3')}</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="group relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="relative">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-1">{t('cta.license.title')}</h3>
                      <p className="text-primary font-medium">{t('cta.license.subtitle')}</p>
                    </div>
                  </div>
                  <ul className="space-y-3 text-gray-600">
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>{t('cta.license.feature1')}</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>{t('cta.license.feature2')}</span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>{t('cta.license.feature3')}</span>
                    </li>
                  </ul>
                </div>
              </div>
